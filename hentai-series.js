...
function saveSessionState() {
    sessionStorage.setItem('seriesSort', currentSort);
    sessionStorage.setItem('seriesPage', currentPageNum);
}

function restoreSessionState() {
    const sort = sessionStorage.getItem('seriesSort');
    const page = sessionStorage.getItem('seriesPage');
